    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl space-y-10 animate-fade-in-up">
      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 p-5 sm:p-6 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex flex-col bg-gray-900/50 backdrop-blur-sm p-3 sm:p-4 rounded-lg border border-gray-700/50 sm:items-end">
            ...
            <div
              key={totalBalance}
              className="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-emerald-300 to-teal-200 truncate transition-all duration-300"
            >
      ...
      <div className="flex justify-center pt-8 pb-12">
        <button
          ...
          className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gray-800 hover:bg-gray-700 text-emerald-400 rounded-2xl font-semibold border border-emerald-500/30 hover:border-emerald-500/60 shadow-lg shadow-emerald-900/20 transition-all duration-300 overflow-hidden hover:scale-105 active:scale-95"
        >
