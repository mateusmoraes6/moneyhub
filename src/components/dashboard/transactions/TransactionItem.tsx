        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={`p-2 rounded-lg text-sm font-medium transition-all duration-300 ${editedType === 'income'
            ...
            <button
              ...
              className={`p-2 rounded-lg text-sm font-medium transition-all duration-300 ${editedType === 'expense'
